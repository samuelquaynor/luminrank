...
import { selectLeagueById, selectLeagueMembers } from '../../features/leagues/store/league.selectors';
import { selectMatchRecording, selectMatchError } from '../../features/matches/store/match.selectors';
import { recordMatch, clearMatchError } from '../../features/matches/store/match.actions';
import { loadLeaderboard } from '../../features/matches/store/leaderboard.actions';
import { League, LeagueMember } from '../../features/leagues/models/league.model';
import { CreateMatchRequest, MatchResult } from '../../features/matches/models/match.model';
    ...
    <div class="min-h-screen bg-bg-primary py-8 px-4">
      <div class="max-w-2xl mx-auto">
        ...
        <form [formGroup]="matchForm" (ngSubmit)="onSubmit()" class="space-y-6">
          ...
          <div class="p-6 bg-bg-secondary rounded-lg border border-border">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                />
                <p
                  *ngIf="matchForm.get('player1Score')?.invalid && matchForm.get('player1Score')?.touched"
                  class="mt-1 text-sm text-red-400"
                >
              ...
              <div>
                ...
                <p
                  *ngIf="matchForm.get('player1Result')?.invalid && matchForm.get('player1Result')?.touched"
                  class="mt-1 text-sm text-red-400"
                >
          ...
          <div class="p-6 bg-bg-secondary rounded-lg border border-border">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                />
                <p
                  *ngIf="matchForm.get('player2Score')?.invalid && matchForm.get('player2Score')?.touched"
                  class="mt-1 text-sm text-red-400"
                >
                  Please enter a valid score
                </p>
              ...
              <div>
                ...
                <p
                  *ngIf="matchForm.get('player2Result')?.invalid && matchForm.get('player2Result')?.touched"
                  class="mt-1 text-sm text-red-400"
                >
                  Please select a result
                </p>
          ...
          <!-- Form Errors -->
          <div *ngIf="formError" class="p-4 bg-red-500/10 border border-red-500/20 rounded-lg text-red-400">
            {{ formError }}
          </div>
...
export class RecordMatchComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.league$ = this.store.select(selectLeagueById(this.leagueId));
    this.members$ = this.store.select(selectLeagueMembers(this.leagueId));
  ...
  onSubmit(): void {
    ...
    if ((formValue.player1Result === 'win' && formValue.player2Result !== 'loss') ||
